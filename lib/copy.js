// JEDINI IZVOR VIDLJIVOG SADRŽAJA — sav tekst na stranici se nalazi ovde.
// Komponente ne smeju imati fiksno upisane nizove karaktera.
export const copy = {
  metadata: {
    ...
    productName: "Knjiga „500 kolača Baka Rade“",
  },

  hero: {
    urgencyBar: "PONUDA ISTIČE DANAS · 90% POPUSTA samo danas",
    badge: "Nova knjiga recepata · +3.200 zadovoljnih korisnika",
    headline: {
    ...
    subheadline:
      "Otkrijte 500 recepata za mekane, vazdušaste i ukusne kolače, potpuno bez glutena, mlečnih proizvoda i šećera. Uživajte u svakom zalogaju bez tegoba ili odricanja.",
    ...
    trustChips: [
      ...
      { icon: "🥛", text: "Bez mlečnih proizvoda" },
      { icon: "🍬", text: "Bez šećera" },
    ],
    image: {
      src: "/hero-mockup.webp",
      alt: "Knjiga 500 zdravih kolača Baka Rade",
    },
    floatingBadges: {
      speed: { icon: "⏱️", top: "Spremno za", bottom: "20 min" },
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "📖", title: "Jednostavna uputstva korak po korak" },
    ],
  },
  ...
  samples: {
    ...
    items: [
      ...
      },
      {
        ...
        alt: "Tres leće torta bez laktoze",
      },
      {
  ...
  moreRecipesCta: {
    ...
    ctaLabel: "PREUZMI SVOJ PRIMERAK ODMAH",
  },

  testimonials: {
    kicker: "Iskustva kupaca",
    headline: "POGLEDAJ ŠTA KAŽU ONI KOJI VEĆ PEKU SA NAMA",
    ...
    items: [
      ...
      {
        text: "Nije mi bilo jasno kako nešto može biti tako ukusno bez mleka i šećera. Tres leće torta bez laktoze me je ostavila bez teksta 🤯 Već 3 dana pečem kolače bez prestanka.",
        time: "11:47",
      },
      {
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 modernih kolača",
        items: [
          { src: "/preview/1-7.webp", alt: "Moderni kolač 1" },
          { src: "/preview/2-6.webp", alt: "Moderni kolač 2" },
          { src: "/preview/3-5-1.webp", alt: "Moderni kolač 3" },
          { src: "/preview/4-3.webp", alt: "Moderni kolač 4" },
        ],
      },
      {
  ...
  story: {
    ...
    paragraphs: [
      ...
      "Kao nutricionista, odlučila sam da zajedno sa majkom pretvorim te recepte u bezbedne varijante: bez šećera, bez glutena i bez laktoze. Nakon mnogo pokušaja, postigle smo rezultate koji su iznenadili čak i samu Baka Radu.",
  ...
  bonuses: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Sveže, jednostavne i zdrave salate, kako biste svaki dan uživali u balansu i ukusu.",
        price: "1.990 din",
        freeLabel: "DANAS BESPLATNO",
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "✅", text: "Možeš ih pregledati i na tabletu." },
      { icon: "♾️", text: "Doživotni pristup: uključujući sve nove recepte." },
  ...
  guarantee: {
    kicker: "Bez rizika",
    headline: "PROBAJ BEZ RIZIKA — 14 dana bezuslovne garancije.",
    body: "Imaš 14 dana da ih testiraš. Ako te recepti ne oduševe, vratićemo ti novac do poslednjeg dinara. Bez komplikacija. Bez stresa.",
    alt: "Pečat za 14 dana bezuslovne garancije",
    image: { src: "/guarantee-badge.webp", alt: "14 dana garancije" },
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Idealni su za početnike! Sve je objašnjeno korak po korak, sa uobičajenim sastojcima i jednostavnim uputstvima. Ako znaš da uključiš rernu, znaćeš da ih napraviš.",
      },
      {
        q: "Čime se zaslađuju kolači?",
        a: "Možeš izabrati ono što najviše voliš: voćem (banana ili urme), medom ili zaslađivačima poput stevije i eritritola. U svakom receptu je navedena tačna količina.",
      },
      {
        q: "Da li mogu da zamenim šećer voćem (banana, urme)? Kako se to radi?",
        a: "Da, naravno! I lakše je nego što izgleda: u receptu piše koje voće da koristiš, koliko da dodaš i kako da napraviš savršen rezultat.",
      },
      {
      ...
      },
      {
        ...
        a: "Za većinu je potrebno samo 20 ili 30 minuta. Dok skuvaš kafu, kolač će već mirisati celom kućom.",
      },
    ],
  },
